...
public class ProductDetailActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onResume() {
        ...
        new BasicUtill().CheckStatus(ProductDetailActivity.this,0,rl_main);
    }
...
//        iv_banner.setLayoutParams(new RelativeLayout.LayoutParams(width,height));
    ...
    {
        utill=new Utill();
        prefrence=new ChatBusinessSharedPreference(ProductDetailActivity.this);
...
//        Log.e("image path", Uri.fromFile(sharefile).toString());
        ...
        share.putExtra(Intent.EXTRA_TITLE,info.getProductName());
