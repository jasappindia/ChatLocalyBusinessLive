...
public class ChatServiceActivity extends AppCompatActivity implements View.OnClickListener {
    @Override
    protected void onResume() {
        super.onResume();
        ViewGroup rl_main=(ViewGroup)findViewById(R.id.rl_main);
        new BasicUtill().CheckStatus(ChatServiceActivity.this,0,rl_main);
    }
    private ViewPager viewPager;
    private ChatServiceActivity.ProductImageAdapter productImageAdapter;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        productImageAdapter=new ChatServiceActivity.ProductImageAdapter(ChatServiceActivity.this,serviceDetailsModel);
...
//        iv_banner.setLayoutParams(new RelativeLayout.LayoutParams(width,height));
    ...
    {
        utill=new Utill();
        prefrence=new ChatBusinessSharedPreference(ChatServiceActivity.this);
            ...
            */
            ...
            case R.id.iv_edit:
                if(prefrence.getAddSevice().equalsIgnoreCase("1")) {
                    Intent intent = new Intent(ChatServiceActivity.this, EditServiceActivity.class);
...
//        Log.e("image path", Uri.fromFile(sharefile).toString());
    ...
    public void share_bitMap_to_Apps() {
        ...
        i.putExtra(Intent.EXTRA_STREAM, getImageUri(ChatServiceActivity.this, getBitmapFromView(ll_share)));
        try {
