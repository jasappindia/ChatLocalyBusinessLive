...
/********constants by shiv**********/
    ...
    public static final int  FINISH=1811;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        /////////////////commented by shiv //////////////applogic code
...
////////////////////////uncomment if want to show the date of chat messages////////////////
            if (type == 3) {
           ...
           /* TextView channelMessageTextView = (TextView) customView.findViewById(R.id.channel_message);
            ...
            channelMessageTextView.setVisibility(View.GONE);*/
            return customView;
        } else if (type == 5) {
...
//                if (alCustomizationSettings.isLaunchChatFromProfilePicOrName()) {        // applozic code uncomment to launch chat on clicking name
...
//////////////////////////code by shiv///////////////
                            Intent intent= null;
                            try {
                                intent = new Intent(context,Class.forName("com.chatlocalybusiness.activity.UserProfileActivity"));
                                intent.putExtra(DetailedConversationAdapter.CHAT_USER_ID,message.getContactIds());
                                context.startActivity(intent );
...
//                        new SetResponseByUser().execute();
            ...
            attachmentView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
/*********************code by shiv  start ***********************/
                    if(message.getMetaDataValueForKey(BILL_CONFIRMATION_CODE)!=null)
                    {
                        Intent intent= null;
                        try {
                            intent = new Intent(context,Class.forName("com.chatlocalybusiness.activity.ChatInvoiceActivity"));
                            intent.putExtra(BILL_ORDER_ID,message.getMetaDataValueForKey("BILL_ORDER_ID"));
                    ...
                    else if(message.getMetaDataValueForKey(PRODUCT_KEY)!=null)
                    {

                        Intent intent= null;
                        try {
                            intent = new Intent(context,Class.forName("com.chatlocalybusiness.activity.ChatProductActivity"));
                            intent.putExtra(PRODUCT_KEY,message.getMetaDataValueForKey(PRODUCT_KEY));
                            context.startActivity(intent);
                    ...
                    else if(message.getMetaDataValueForKey(SERVICE_KEY)!=null){


                        Intent intent= null;
                        try {
                            intent = new Intent(context,Class.forName("com.chatlocalybusiness.activity.ChatServiceActivity"));
                            intent.putExtra(SERVICE_KEY,message.getMetaDataValueForKey(SERVICE_KEY));
                            context.startActivity(intent);
