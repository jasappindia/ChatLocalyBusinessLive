...
//    public String customMessageBackgroundColor = "#FF03A9F4";
    public String customMessageBackgroundColor = "#3579f0";
    private String sentMessageBackgroundColor = "#3579f0";
    private String receivedMessageBackgroundColor = "#FFFFFFFF";
//    private String sendButtonBackgroundColor = "#3579f0";
    private String sendButtonBackgroundColor = "#F0F0F0";
    private String attachmentIconsBackgroundColor = "#3579f0";
    ...
    private String sentMessageBorderColor = "#3579f0";
    private String receivedMessageBorderColor = "#FFFFFFFF";
    private String channelCustomMessageBorderColor = "#cccccc";
    private String collapsingToolbarLayoutColor = "#3579f0";
    private String groupParticipantsTextColor = "#3579f0";
    private String groupDeleteButtonBackgroundColor = "#3579f0";
    private String groupExitButtonBackgroundColor = "#3579f0";
    private String adminTextColor = "#3579f0";
    private String adminBackgroundColor = "#FFFFFFFF";
    private String attachCameraIconName = "applozic_ic_action_camera_new";
    private String adminBorderColor = "#3579f0";
