...
public class ConversationFragment extends MobiComConversationFragment implements SearchListFragment {
    ...
    private ImageView iv_billgenrate;
    private String customerId;
  private ChatLocallyAppLozicPrefrence chatLocallyAppLozicPrefrence;
    public static ConversationFragment newInstance(Contact contact, Channel channel, Integer conversationId, String searchString,String customerId) {
        ...
        if(customerId!=null)
            args.putString(ConversationUIService.CUSTOMER_ID,customerId);
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (bundle != null) {
            ...
            customerId=bundle.getString(ConversationUIService.CUSTOMER_ID);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        iv_billgenrate=(ImageView)getActivity().findViewById(R.id.iv_billgenrate);
        iv_billgenrate.setVisibility(View.VISIBLE);

        iv_billgenrate.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                if(chatLocallyAppLozicPrefrence.getEditBill().equalsIgnoreCase("1")){
                try {
                    Intent intent=new Intent(getActivity(),Class.forName("com.chatlocalybusiness.activity.BuyerInfoActivity"));
                    intent.putExtra("CustomerId",customerId);

                    startActivityForResult(intent, DetailedConversationAdapter.FINISH);
                } catch (ClassNotFoundException e) {
                    e.printStackTrace();
                }}
                else Toast.makeText(getActivity(), R.string.chatlocaly_permission_denied, Toast.LENGTH_SHORT).show();
            }
        });
