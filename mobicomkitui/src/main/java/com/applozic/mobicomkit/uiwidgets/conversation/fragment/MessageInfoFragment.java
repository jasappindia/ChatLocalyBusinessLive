...
import static com.applozic.mobicomkit.uiwidgets.conversation.activity.ConversationActivity.tv_toolBartitle;
...
public class MessageInfoFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
       ...
       title= tv_toolBartitle.getText().toString();
        tv_toolBartitle.setText("View History");
        ...
        ImageView iv_billgenrate = (ImageView) getActivity().findViewById(R.id.iv_billgenrate);
