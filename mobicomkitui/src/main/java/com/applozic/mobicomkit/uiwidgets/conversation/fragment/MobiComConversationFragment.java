...
*/
        ...
        recordButton.setOnClickListener(new View.OnClickListener() {
                                            ...
                                            public void onClick(View view) {
                                                ...
                                                if (chatLocallyAppLozicPrefrence.getSendAudio().equalsIgnoreCase("1"))
                                                    ...
                                                    Toast.makeText(getActivity(), R.string.chatlocaly_permission_denied, Toast.LENGTH_SHORT).show();
                                                handleSendAndRecordButtonView(false);
        ...
        sendButton.setOnClickListener(new View.OnClickListener() {
                                          ...
                                          public void onClick(View view) {
                                              emoticonsFrameLayout.setVisibility(View.GONE);
                                              if (chatLocallyAppLozicPrefrence.getSendMessage().equalsIgnoreCase("1"))
                                                  sendMessage();
                                              else
                                                  Toast.makeText(getActivity(), R.string.chatlocaly_permission_denied, Toast.LENGTH_SHORT).show();
...
// last visible date
                                             ...
                                             try {
                                                 if (messageList != null && messageList.size() > 0 && firstVisibleItem + amountVisible > 0) {
                                                     ...
                                                     if (DateUtils.isSameDay(message.getCreatedAtTime())) {
                                                         tv_dateshow.setText(R.string.today);
                                                     } else {
                                                         tv_dateshow.setText(simpleDateFormat.format(new Date(message.getCreatedAtTime())));
...
*/
    ...
    public void setResponse() {
        ...
        param.put("b_user_id", ConversationActivity.buserId);
